...
require '../backend/paystack_config.php';
...
<body>
    ...
    <script>
        ...
        function payWithPaystack() {
            ...
            fetch('../backend/paystack_initialize.php', {
                method: 'POST',
            ...
            .then(data => {
                ...
                const handler = PaystackPop.setup({
                    ...
                    callback: function(response) {
                        ...
                        window.location.href = '../backend/paystack_callback.php?reference=' + encodeURIComponent(response.reference);
                    },
                    onClose: function() {
                        btn.disabled = false;
                    }
